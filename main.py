...
def main():
    create_tables()
    # यहाँ सिर्फ builder को सुधारा है ताकि सर्वर पर क्रैश न हो
...
if __name__ == "__main__":
    main()
 मुझे मैंने चेक करना है इसमें कोई बग है क्या क्योंकि यह टाइम टू टाइम की नहीं प्रोवाइड कर रहा है। ऐड किया लेकिन फिर भी की प्रोवाइड नहीं कर रहा है। इस कोडिंग में मेरे जितने भी फीचर है, वह सभी को इसमें जो भी बग है, उसको फिक्स करके मेरे जैसी को सेंड करना।