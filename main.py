...
async def message_handler(update, context):
    ...
    if user_id == ADMIN_ID:
        ...
        elif text == "🔑 Add Keys": context.user_data["state"] = "wait_key"; await update.message.reply_text("Send key in format: GameName | Plan | Key")
        ...
        elif text == "📊 Stock": await update.message.reply_text(f"📊 Stock: {get_total_stock()}")
...
async def button_click(update, context):
    ...
    if query.data.startswith("game_"):
        ...
        if action == "acc":
            ...
            # यहाँ है आपका वो बड़ा रिजेक्शन मैसेज
            rej_msg = "❌ *Payment Rejected*\n\nYour payment screenshot was invalid or unclear. Please send a clear screenshot showing the transaction ID, date, and time. If you think this is an error, contact support."
