...
if __name__ == "__main__":
    main()
 इसमें जो भी प्राइसिंग है, प्राइस चेंज मत करना। बाकी मैंने जो बोला है, वह बस ऐड करके देना, ठीक? और यह सभी इसमें काम करना चाहिए। इसमें जो भी फीचर है सभी न्यू कोडिंग में ऐड कर दो और मैंने आपको ऐड करने को बोला है वह ऐड कर दो। क्रैशिंग वगैरह