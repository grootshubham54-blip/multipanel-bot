...
async def button_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.answer() # यह बटन से Loading... हटा देगा
    
    if query.data.startswith("buy_"):
        # यहाँ फोटो का लिंक या File ID डालें
        # पक्का करें कि लिंक में कोई रीजनल ब्लॉक न हो
        await query.message.reply_photo(photo="https://telegra.ph/file/a4d3b84f33d1c4e95155f.jpg", caption="✅ पेमेंट करके स्क्रीनशॉट भेजें।")
        ...
        await context.bot.send_message(user_id, f"✅ आपकी पेमेंट {action} हो गई है।")
