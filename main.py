...
GAME_PLANS = {
    ...
    "🪐 ✦ 𝕄𝕒𝕣𝕤 𝕃𝕠𝕒𝕕-𝕖𝕣 ✦": {"1 Day": "130", "1 Week": "599"},
...
async def message_handler(update, context):
    ...
    if user_id == ADMIN_ID and text.startswith("Maintenance:"):
        ...
        return
    # [आपका पुराना message_handler लॉजिक यहाँ है]
    if text == "🔙 Back": context.user_data.clear(); await start(update, context)
    # ... बाकी पुराना लॉजिक यहाँ आएगा ...

async def button_click(update, context):
    query = update.callback_query; await query.answer()
    # [आपका पुराना button_click लॉजिक यहाँ है]
    pass

def main():
    create_tables()
    # यहाँ 'concurrent_updates=True' को हटाकर स्टैंडर्ड बिल्डर का उपयोग किया है जो क्रैश नहीं होता
