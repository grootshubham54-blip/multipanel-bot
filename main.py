...
async def button_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data.startswith("buy_"):
        ...
        # अगर फाइल मिलेगी तो फोटो भेजेगा, वरना लिंक से उठाएगा
        if os.path.exists(file_path):
            with open(file_path, "rb") as photo:
                await query.message.reply_photo(photo=photo, caption="✅ यह रहा QR कोड। पेमेंट करके स्क्रीनशॉट भेजें।")
        else:
            await query.message.reply_photo(photo="https://telegra.ph/file/0c32608447814c81a54a0.jpg", caption="✅ QR कोड: पेमेंट करके स्क्रीनशॉट भेजें।")
