...
async def start(update, context):
    ...
    welcome_text = "🎮 Welcome to IOS SHUBHAM License Store. Choose an option below."
...
async def message_handler(update, context):
    ...
    if user_id == ADMIN_ID:
        ...
        # Sales Dashboard
            ...
            await update.message.reply_text(f"📊 Total Keys Sold: {sold}")
